...
$(function () {
    $.fn.bubbletips = function (options) {
        ...
        $("body").prepend('<div class="docBubble" id="btip' + bid + '"><i class="triangle-' + options.position + '"></i> <i class="closeBub" title="close" id="btipc' + bid + '">close</i><div class="tl"><div class="inner"><div class="cont">' + options.content + '</div></div></div><div class="tr"></div><div class="bl"></div></div>');
        var $btip = $("#btip" + bid);
        ...
        $btip.live("mouseover", function (e) { $btip.show() });
        $btip.live("mouseout", function (e) { $btip.hide(); });
        if ($("body").has(".docBubble")) {
